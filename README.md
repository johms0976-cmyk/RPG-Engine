...
play over direct connections (see [`docs/REMOTE_PLAY.md`](docs/REMOTE_PLAY.md)), and a Warden deck
that fits on a phone.

**Next** — paper mode, and table analytics off the data `engine/misses.js` and `engine/coverage.js`
