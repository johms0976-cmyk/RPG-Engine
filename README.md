...
Currently ships with a full implementation of **Mothership 1e** and *The Haunting of Ypsilon 14*.
...
`src/modules/_template/index.js` is a working skeleton to copy.
