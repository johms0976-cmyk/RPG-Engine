...
Currently ships with a full implementation of **Mothership 1e** and two modules: *The Haunting of
Ypsilon 14* (one session, 3–4 hours) and *Dead Weight* (ninety minutes, one sitting).
...
**[Play in your browser](https://johms0976-cmyk.github.io/RPG-Engine/)** — no install. Roll a
character, walk into the mine, find out what is living in the ducting.
...
### Play right now
Open the [hosted demo](https://johms0976-cmyk.github.io/RPG-Engine/). Nothing to install.
...
two files, where Ypsilon 14 is a hundred and twenty rooms across eleven.
...
**Next** — a second module, a browser module editor.
