...
const OTHER = defineRuleset({
  ...
  /* No class step, because it has no classes. A ruleset that kept the
     default six steps and declared no classes is a validation error —
     see "what a ruleset may not do" below. */
  create: { steps: ["name", "stats", "skills", "loadout"] },
