...
export default function Join({ snapshot, peers, myName, onName, onClaim, onLocker, onBuild, status }) {
      ...
      <div className="join">
        <Panel title="Waiting for the Warden">
          ...
          <div className="btn-row">
            {onBuild && <Btn kind="primary" onClick={onBuild}>Build a character</Btn>}
