...
export default function DirectorStrip({ move, mod, crew, onTake, onDismiss }) {
  if (!move) return null;
  ...
  return (
    <div className="dir-strip" role="status">
      ...
      <span className="dir-row">
        ...
        <button type="button" className="btn inline small ghost" onClick={() => onDismiss && onDismiss(move)}>
          No
        </button>
      </span>
    </div>
