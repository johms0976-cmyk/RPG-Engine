...
/**
 * Pull the panic out of a feed line, if it is one. The engine writes
 * panic lines as "NAME — description"; anything unparseable still
 * produces a takeover, just without a subtitle.
 */
