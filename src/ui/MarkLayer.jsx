    ...
    <Modal title={`Mark ${roomName || roomId}`} onClose={onClose}>
      <div className="stack">
        <div className="btn-row">
          {/* Sim-owned kinds (water, noise) are omitted: they are the
              world asserting something, not a note the crew can leave. */}
          {Object.entries(MARK_KINDS).filter(([, v]) => !v.sim).map(([k, v]) => (
