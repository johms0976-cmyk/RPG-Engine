...
/* ============================================================
   ...
   ============================================================ */
function namedAnswer({ mod, w, room, roomId, words, pc }) {
  let best = null;
 ...
 */
export function answerLook({ mod, w, pc, about = "" } = {}) {
  ...
  const ctx = { mod, w, pc, room, roomId };
