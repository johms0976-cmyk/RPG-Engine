...
export function createWorld(mod, seed) {
  ...
  return {
    ...
    /* Minutes the party spent in each room, banked by `commitW` when
       the centre of mass moves. `roomSince` is the clock reading at
       the last move. See engine/analytics.js for what this can and
       cannot honestly be read as. */
    roomTime: {},
    roomSince: 0,
    clock: 0,
    day: 0,
