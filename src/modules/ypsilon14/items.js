...
/* ============================================================
   ...
   ============================================================ */
/* `style` picks how the artefact is drawn on a phone — see
   ui/Artefact.jsx. The tapes are cassettes; Giovanni's log is a
   terminal transcript, because that is what the crew is reading it
   off. Purely presentational: nothing here changes what a handout
   does. */
export const handouts = {
  tape1: {
    audio: tapeAudio.tape1.src,
    audioSecs: tapeAudio.tape1.secs,
    audioNote:
      "On the portable player this is a private noise in your ear. On Sonya's boombox it is the loudest thing on Ypsilon 14, and something down here navigates by sound.",
    style: "tape",
    label: "▶ BLUE — 'SONYA'",
  ...
  tape2: {
    audio: tapeAudio.tape2.src,
    audioSecs: tapeAudio.tape2.secs,
    audioNote:
      "Held to your ear. Nobody else at this table hears a word of it unless you tell them.",
    style: "tape",
  ...
  tape3: {
    audio: tapeAudio.tape3.src,
    audioSecs: tapeAudio.tape3.secs,
    audioNote:
      "Held to your ear. The last ninety seconds are on the tape as well.",
    style: "terminal",
