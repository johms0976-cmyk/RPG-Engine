...
export const items = {
  ...
  chemo: {
    ...
    d: "Twenty-five litres, frozen. Written up for radiation exposure. Somebody in this colony was buying it for a different reason and did not write that part down.",
  },
  ...
  coatedammo: {
    ...
    d: "Ordinary shots finished in Edem's compound. They go through carapace like it is not there. There are never as many as you would like.",
    grants: [{ tags: ["carc"], bonus: 20 }],
  },

  /* ---------------- small things people leave behind ---------------- */
  tinfoilhat: {
    n: "Foil Cap", found: true,
    d: "Hand-folded, carefully, by somebody who had worked out that the thing coming for them arrived over the air. They were right about the mechanism and wrong about the remedy.",
  },
  rosary: {
    n: "Rosary", found: true,
