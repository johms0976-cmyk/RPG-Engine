...
export const heron = {
  hangar: {
    ...
    features: {
      ...
      stockpile: {
        ...
        gives: ["pulserifle", "fraggrenades"], mins: 10,
      },
      generator: {
      ...
      door: {
        ...
        effects: [
          { when: "has:controlcard",
            ...
            else: [{ say: "Sealed. Somebody on the other side of the dam is carrying the answer to this in a breast pocket.", tone: "system" }] },
        ],
      },
      carc: {
  ...
  stairs: {
    ...
    exits: [
      ...
      { to: "reactor", label: "Swim down to the jammed hatch → the Hydroreactor [14]", mins: 10, effects: [{ run: "swimDown" }] },
    ],
    features: {
      water: {
