...
export const CONSEQUENCE_KINDS = new Set([
  ...
  "rollbad", "item", "whisper",
  // The Warden speaking to the table in their own words. If anything
  // deserves the player looking up from the log, it is a person
  // talking rather than the module talking.
  "interject",
]);
