...
const LABELS = {
  ...
  /* B.3/B.4. Both should read as things a person does rather than
     things a system processes, because both are meant to feel
     free — a label like "Submitting reaction" would make a reflex
     into a transaction. */
  react: "Reacting",
  offerAssist: "Offering to help",
  withdrawAssist: "Taking it back",
};
